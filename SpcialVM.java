...
public class SpecialVM extends VendingMachine {
	...
	private void loadRecipes() {
		...
		this.addToRecipe("ClassicBurger", new Topping("IcebergLettuce", 3.0, false, 45, 1));
		this.addToRecipe("ClassicBurger", new Topping("DillPickles", 11.0, false, 45, 1));
		...
		this.addToRecipe("CheesyCheeseburger", new Topping("BeefsteakTomato", 18.0, false, 50, 1));
		...
		this.addToRecipe("BeyondBurger", new Meat("BeyondBeef", 210.0, true, 330, 1));
		this.addToRecipe("BeyondBurger", new Topping("MozzarelaCheese", 140.0, false, 75, 1));
		...
		this.addToRecipe("MeatOverloadBurger", new Topping("MozzarelaCheese", 140.0, false, 75, 1));
		...
		this.addToRecipe("SpicyTapaBurger", new Condiment("HotSauce", 11.0, false, 50, 1));
		...
		this.addToRecipe("SalmonBurger", new Topping("BeefsteakTomato", 18.0, false, 50, 1));
		this.addToRecipe("SalmonBurger", new Topping("IcebergLettuce", 3.0, false, 45, 1));
		this.addToRecipe("SalmonBurger", new Topping("DillPickles", 11.0, false, 45, 1));
		...
		this.addToRecipe("TurkeyBurger", new Topping("BeefsteakTomato", 18.0, false, 50, 1));
